...
~/.nvm/versions/node/v8.10.0/bin/cfn-lint validate ./audi-cf-test/Wordpress_CF_template.json  2>>&1 | sed -r 's/'$(echo -e "\033")'\[[0-9]{1,2}(;([0-9]{1,2})?)?[mK]//g' | tee validation-report.html
